...
// const requiredEnvVars = ['MONGODB_URI', 'TWILIO_ACCOUNT_SID', 'TWILIO_AUTH_TOKEN', 'TWILIO_PHONE_NUMBER'];
...
// // Admin credentials (in production, use proper authentication like bcrypt)
// const ADMIN_CREDENTIALS = {
//   username: process.env.ADMIN_USERNAME || 'admin',
//   password: process.env.ADMIN_PASSWORD || 'admin123'
// };

// // Initialize rooms with retry logic
...
//       customerAddress,
//       roomType, 
//       selectedRooms, // Now an array of room objects
//       checkInDate, 
//       checkOutDate,
//       arrivalTime,
//       specialRequests,
...
//       sendBookingNotifications(savedBooking, rooms);
...
// async function sendBookingNotifications(booking, rooms) {
//   try {
//     // Customer SMS - only send if customer phone is different from Twilio number
//     if (booking.customerPhone !== process.env.TWILIO_PHONE_NUMBER) {
//       await twilioClient.messages.create({
//         body: `Thank you ${booking.customerName}! Your booking for ${rooms.length} ${booking.roomType} room(s) is confirmed from ${booking.checkInDate.toDateString()} to ${booking.checkOutDate.toDateString()}. Total: ₹${booking.totalAmount}.`,
//         from: process.env.TWILIO_PHONE_NUMBER,
//         to: booking.customerPhone
//       });
//     } else {
//       console.log('Skipping customer SMS - same as Twilio number');
//     }
    
//     // Admin SMS if configured and different from Twilio number
//     if (process.env.ADMIN_PHONE_NUMBER && 
//         process.env.ADMIN_PHONE_NUMBER !== process.env.TWILIO_PHONE_NUMBER) {
//       await twilioClient.messages.create({
//         body: `New booking: ${booking.customerName} booked ${rooms.length} ${booking.roomType} room(s) from ${booking.checkInDate.toDateString()} to ${booking.checkOutDate.toDateString()}.`,
//         from: process.env.TWILIO_PHONE_NUMBER,
//         to: process.env.ADMIN_PHONE_NUMBER
//       });
//     } else if (process.env.ADMIN_PHONE_NUMBER) {
//       console.log('Skipping admin SMS - same as Twilio number');
//     }
//   } catch (smsError) {
